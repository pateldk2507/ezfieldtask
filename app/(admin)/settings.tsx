...
export default function AdminSettings() {
  ...
  const addContactMutation = useMutation({
    mutationFn: (data: { name: string; phone: string }) =>
      apiPost("/api/emergency-contacts", data),
    onSuccess: () => {
    ...
    onError: (err: any) => {
      showToast(err.message || "Failed to add emergency contact", "error");
    },
  });
  ...
  const deleteContactMutation = useMutation({
    ...
    onError: (err: any) => {
      showToast(err.message || "Failed to remove emergency contact", "error");
    },
  });
        ...
        <View style={[styles.section, { backgroundColor: theme.surface }]}>
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: theme.border, true: theme.tint + "60" }}
        ...
        <View style={[styles.section, { backgroundColor: theme.surface }]}>
          {emergencyContacts.map((contact: any) => (
            <View key={contact.id} style={styles.contactRow}>
              <View style={styles.contactInfo}>
                ...
                <View>
                  <Text style={[styles.contactName, { color: theme.text, fontFamily: "Inter_500Medium" }]}>
                    {contact.name}
                  </Text>
                  <Text style={[styles.contactPhone, { color: theme.textSecondary, fontFamily: "Inter_400Regular" }]}>
                    {contact.phone}
                  </Text>
                </View>
              </View>
              <Pressable onPress={() => deleteContactMutation.mutate(contact.id)}>
          ...
          {showAddContact ? (
            <View style={styles.addContactForm}>
              <TextInput
                style={[styles.contactInput, { color: theme.text, borderColor: theme.border, fontFamily: "Inter_400Regular" }]}
            ...
            <Pressable style={styles.addContactRow} onPress={() => setShowAddContact(true)}>
              ...
              <Text style={[styles.addContactText, { color: theme.tint, fontFamily: "Inter_500Medium" }]}>
